...
public class Autohändler {
    ...
    public void printModelle(){
        ...
        Kinderauto auto4 = new Kinderauto("Kinderauto", 101, 2.5, "rot");
        ...
        System.out.println("Beispiel 4 Name: " + auto4.getName() + " Typ: " + auto4.getTyp() + " PS Zahl: " + auto4.getPsZahl() + " hat Klima ? " + auto4.isHatKlima() +" Alter des Kindes:" + auto4.getKinderalter() + "Farbe: " +auto4.getFarbe());
    }
}
